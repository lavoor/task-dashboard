<template>
	<div
		...
		<div
			@click="expandMenu"
			class="flex items-center gap-3 cursor-pointer text-slate-500 hover:text-slate-600 dark:text-zinc-400 dark:hover:text-zinc-50">
			<span
		...
		<Transition>
			<div
				...
				<span
					...
					:key="sorting.value"
					class="font-medium font-inter cursor-pointer duration-150 text-slate-500 hover:text-slate-800 dark:text-zinc-400 dark:hover:text-zinc-50"
