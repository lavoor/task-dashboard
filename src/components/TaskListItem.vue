<template>
	<div
		class="flex flex-col py-5 w-full gap-2 bg-slate-50 dark:bg-zinc-900 duration-150 border-slate-300 dark:border-zinc-700 border-t-[1px]">
			...
			<div class="flex justify-between items-center gap-4">
				...
				<div class="flex gap-6 items-center min-w-max">
					<div
						...
						class="flex items-center gap-2 text-red-400 duration-150 hover:text-red-500 cursor-pointer select-none">
						...
						<span
							class="hidden md:inline text-current font-inter text-sm"
							>Remove</span
						>
					</div>
					<div
						@click="showEditTaskDialog(task)"
						class="flex items-center gap-2 text-slate-500 duration-150 hover:text-slate-600 dark:text-zinc-400 dark:hover:text-zinc-300 cursor-pointer select-none">
						<span class="text-current">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="14"
