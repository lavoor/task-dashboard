<template>
	<span
		@click="chooseOption('list')"
		class="duration-150 cursor-pointer"
		:class="
			selected
				? 'text-slate-500 dark:text-zinc-300'
				: 'text-slate-400 hover:text-slate-500 dark:text-zinc-400 dark:hover:text-zinc-300'
		">
		<svg
